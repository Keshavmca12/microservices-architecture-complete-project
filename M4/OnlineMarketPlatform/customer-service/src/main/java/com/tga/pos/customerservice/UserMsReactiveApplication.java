package com.tga.pos.customerservice;
...
//@SpringBootApplication(scanBasePackages = "com.tga.pos.customerservice",exclude = { MongoAutoConfiguration.class, MongoDataAutoConfiguration.class })
